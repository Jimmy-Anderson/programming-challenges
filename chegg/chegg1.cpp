...
int main()
{
  ...
  int adjMatrix[N][N] =
  { 
    {    0, INT_MAX,    -2, INT_MAX, INT_MAX , INT_MAX  },
    {    3,    0,   INT_MAX  , INT_MAX, INT_MAX, INT_MAX },
    { INT_MAX, 4,    0 , INT_MAX,1,3},
    { INT_MAX, INT_MAX,    -1, 0,1,INT_MAX},
    { INT_MAX, INT_MAX,INT_MAX,    2, 0,1},
    {4,INT_MAX,4, INT_MAX, INT_MAX,0}
  };
